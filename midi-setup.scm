...
(begin
  ...
  (define *i:px1* (make-dest "Kurzweil PX1000 chan 5" *px* 4))
  (define *i:px7* (make-dest "Kurzweil PX1000 chan 7" *kz* 6))
  (define *i:px8* (make-dest "Kurzweil PX1000 chan 8" *kz* 7))
  (define *i:px9* (make-dest "Kurzweil PX1000 chan 9" *kz* 8))
